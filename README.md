...
That said, I did go beyond the core requirements by adding three bonus features — debounced search, sorting, and skeleton loaders. Each one added real value to the experience without overcomplicating the codebase.
